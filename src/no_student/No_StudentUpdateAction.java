...
@WebServlet(urlPatterns={"/no_student/no_student_update_action"})
public class No_StudentUpdateAction extends HttpServlet {
	public void doGet (
			...
			try{
				...
				request.getRequestDispatcher("no_student_update.jsp")
