        ...
        <section class="mo-4">
            ...
            <c:choose>
                <c:when test="${students.size()>0}">
                    ...
                    <table class="test-table test-table table-hover mx-3">
                        <tr>
                            ...
                            <th class="test-boder student-table-wide">誕生日</th>
                        ...
                        <c:forEach var="student" items="${students}">
                            <tr>
                                ...
                                <td class="test-boder student-table-wide"><a href="../no_student/NoStudentUpdate.action?ent_year=${student.entYear}&no=${student.no}&name=${student.name}&classnum=${student.classNum}&birth_day=${student.birthDay}">変更</a></td>
                                <td class="test-boder student-table-wide"><a href="no_student_delete.jsp?no=${student.no}">削除</a></td>
                            </tr>
                        </c:forEach>
                    </table>
                </c:when>
